...
public class MainActivity extends AppCompatActivity implements
    ...
    public void incrementWater(View view) {
        ...
        mToast.show();
        // DO (15) Create an explicit intent for WaterReminderIntentService
        Intent intent = new Intent(this, WaterReminderIntentService.class);
        // DO (16) Set the action of the intent to ACTION_INCREMENT_WATER_COUNT
        intent.setAction(ReminderTasks.ACTION_INCREMENT_WATER_COUNT);
        // DO (17) Call startService and pass the explicit intent you just created
        startService(intent);
    }
