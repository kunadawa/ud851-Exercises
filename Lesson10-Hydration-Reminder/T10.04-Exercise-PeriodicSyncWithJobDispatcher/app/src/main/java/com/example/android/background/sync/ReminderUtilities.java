...
public class ReminderUtilities {
    // DO (15) Create three constants and one variable:
    ...
    // DO (16) Create a synchronized, public static method called scheduleChargingReminder that takes
    ...
    // Checkout https://github.com/firebase/firebase-jobdispatcher-android for an example
        // DO (17) If the job has already been initialized, return
        // DO (18) Create a new GooglePlayDriver
        // DO (19) Create a new FirebaseJobDispatcher with the driver
        // DO (20) Use FirebaseJobDispatcher's newJobBuilder method to build a job which:
        ...
        // DO (21) Use dispatcher's schedule method to schedule the job
        // DO (22) Set sInitialized to true to mark that we're done setting up the job
}
